              ...
              <button
                className={`w-20 h-20 rounded-full flex flex-col items-center justify-center transition-all ${
                  recordingState === 'recording'
                    ...
                    : conversationState !== 'idle' || endingConversation || isPlayingAudio
                ...
                disabled={conversationState !== 'idle' || endingConversation || isPlayingAudio}
              >
                {recordingState === 'recording' ? (
                  <>
            ...
            <button
              className={`w-20 h-20 rounded-full flex flex-col items-center justify-center transition-all ${
                isFreeTalkMode
                  ...
                  : conversationState !== 'idle' || endingConversation || !speechSupported || isPlayingAudio
                  ? 'bg-gray-300 text-gray-500 cursor-not-allowed'
                  : 'bg-gray-600 text-white hover:bg-gray-700'
              }`}
              onClick={isFreeTalkMode ? stopFreeTalkMode : startFreeTalkMode}
              disabled={conversationState !== 'idle' || endingConversation || !speechSupported || isPlayingAudio}
            >
              {isFreeTalkMode ? (
                <>
